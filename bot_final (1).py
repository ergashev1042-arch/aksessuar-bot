...
YOUR_NAME = "Muxammad-Ali"

BOT_ACTIVE = True

KEYWORD_RESPONSES = {
    "salom": "Salom! Hozir band eman, tez orada javob beraman",
    "narx": "Narx haqida tez orada javob beraman.",
    "qachon": "Imkon topilishi bilan javob beraman!",
...
def get_ai_response(message_text, sender_name):
    try:
        prompt = (
            ...
            "Har doim O'zbek tilida javob ber. 1-2 jumladan oshirma. "
            "Xabar: " + sender_name + " yozdi: " + message_text
        )
...
async def control_bot(event):
    ...
    BOT_ACTIVE = (cmd == "on")
    status = "YOQILDI" if BOT_ACTIVE else "OCHIRILDI"
...
async def main():
    ...
    logger.info("Faqat shaxsiy xabarlarga javob beradi")
